                        ...
                        <li class="cart-icon">
                            ...
                            <div class="cart-hover">
                                ...
                                <div class="select-button">
                                    ...
                                    <a href="check-out.html" class="primary-btn ckeckout-btn">CHECK OUT</a>
                                </div>
                            </div>
                        </li>
    ...
    <div class="nav-item">
        <div class="container">
            ...
            <nav class="nav-menu mobile-menu">
                <ul>
                    <li class="active"><a href="index.blade.html#">Home</a></li>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <ul>
                        <li>Dinh Trang - Duc Tu - Dong Anh - Ha Noi</li>
                        <li>Phone: +84 39.29.29.807</li>
                        <li>Email: chutiendat148@gmail.com</li>
                    </ul>

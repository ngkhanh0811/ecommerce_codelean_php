            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel women">
                        ...
                        <div class="product-item item {{ $womenProducts->tag }}">
                            <div class="pi-pic">
                                <img src="front/img/products/{{$womenProducts->productImage[0]->path}}" alt="">
                                @if($womenProducts->discount != null)
                            ...
                            <div class="pi-text">
                                <div class="catagory-name">{{$womenProducts->tag}}</div>
                                <a href="">
                                    <h5>{{$womenProducts->name}}</h5>
                                </a>
        ...
        <div class="container">
            <div class="col-lg-6 text-center">
                <div class="section-title">
                    ...
                    <p>Loren ipsum dolor sit amet, consectetur adpisicing elit, sed<br />do ipsum ... </p>
                    <div class="product-price">
                        $35.00
                        <span>/ HanBag</span>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel men">
                        ...
                        <div class="product-item item {{ $menProducts->tag }}">
                            <div class="pi-pic">
                                <img src="front/img/products/{{$menProducts->productImage[0]->path}}" alt="">
                                <div class="sale">Sale</div>
                                <div class="icon">
                                    <i class="icon_bag_alt"></i>
                                </div>
                            ...
                            <div class="pi-text">
                                <div class="catagory-name">{{$menProducts->tag}}</div>
                                <a href="">
                                    <h5>{{$menProducts->name}}</h5>
                                </a>
                                <div class="product-price">
                                    @if($menProducts->discount != null)
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="front/img/icon-1.png" alt="icon1">
                            </div>
                            <div class="sb-text">
                                <h6>Free Shippng</h6>
